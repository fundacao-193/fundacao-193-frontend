      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-[#3d685d] font-bold text-xl">•</span>
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-[#3d685d] to-[#2f5349] rounded-xl p-8 text-white">
        ...
        <section className="bg-gradient-to-r from-[#3d685d] to-[#2f5349] rounded-2xl p-8 text-white text-center">
          ...
          <a
            ...
            className="inline-block px-8 py-3 bg-white text-[#3d685d] rounded-lg font-semibold hover:bg-neutral-100 transition-colors"
          >
            Enviar E-mail
          </a>
        </section>
